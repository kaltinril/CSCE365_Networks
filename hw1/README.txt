server_ftp.py
  ...
  Passing too many arugments on the command line will print an error and the example usage
...
client_ftp.py
  ...
  To retrieve a file type get <filename>
    NOTE: If the filenamme you wish to get has spaces, use double quotes  get "my file name.txt"